    ...
    return (
        <header className='fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16 bg-gray-900'>
            ...
            <div className=' hidden md:flex w-full h-full items-center justify-between '>
                ...
                <div className='flex items-center gap-8'>
                    <motion.ul initial={{ opacity: 0, x: 200 }}
                        ...
                        <li className='text-base text-textColor hover:text-orange-500 duration-100 transition-all ease-in-out cursor-pointer'>Services</li>
            ...
            <div className='flex items-center justify-between md:hidden w-full h-full  p-4'>
                ...
                <div className='relative flex items-center justify-center' onClick={showCart}>
                    <MdShoppingBasket className='text-textColor hover:text-orange-500 
                    duration-100 transition-all ease-in-out cursor-pointer text-2xl'/>
                    {cartItems && cartItems.length > 0 && (
                        <div className=" absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartNumBg flex items-center justify-center">
                    ...
                    {isMenu && (
                        <motion.div
                            ...
                            text-textColor text-base'>Home</li>
                                <li className='px-4 py-2 flex items-center bg-gray-50 gap-3 cursor-pointer hover:bg-slate-200 
                            transition-all duration-100 ease-in-out
                            text-textColor text-base'>Menu</li>
                                <li className='px-4 py-2 flex items-center bg-gray-50 gap-3 cursor-pointer hover:bg-slate-200 
                            transition-all duration-100 ease-in-out
                            text-textColor text-base'>About us</li>
                                <li className='px-4 py-2 flex items-center bg-gray-50 gap-3 cursor-pointer hover:bg-slate-200 
                            transition-all duration-100 ease-in-out
                            text-textColor text-base'>Services</li>
                                <li className='px-4 py-2 flex items-center bg-gray-50 gap-3 cursor-pointer hover:bg-slate-200 
                            transition-all duration-100 ease-in-out
